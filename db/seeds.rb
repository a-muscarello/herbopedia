...
Herbies.create(user_name: "lori", user_id: 1)
Herbies.create(user_name: "tom", user_id: 2)
Herbies.create(user_name: "carly", user_id: 3)

Herbs.create(user_id: 1)
Herbs.create(user_id: 2)
Herbs.create(user_id: 3)
Herbs.create(user_id: 1)
Herbs.create(user_id: 2)
Herbs.create(user_id: 3)

Posts.create(user_id: 1, title: "Lavender", description: "Lavandula angustifolia", info_sheet: "Lavender prevents fainting and allays nausea. In oil form, it is often used in therapeutic baths to reduce stress. It can also lower blood pressure. A small amount makes a useful application on skin diseases like eczema and psoriasis.", image: "/assets/images/lavender.jpg")
Posts.create(user_id: 2, title: "Pennyroyal", description: "Mentha pulegium", info_sheet: "Pennyroyal is said to ease headaches. It has been used as a remedy for colicky pains in the abdomen. It has also been known to ease the feverish symptoms that come with measles and whooping cough. Pennyroyal (Mentha pulegium), looks like mint, smells like mint and even tastes like mint but unlike mint contains pulegone, an extremely poisonous compound that is toxic to the liver and acts as an abortificant.
...
Posts.create(user_id: 3, title: "Lovage", description: "Levisticum officinale", info_sheet: "Lovage is used as a digestive aid. It eases inward pains. This herb is also known to diminish redness of the eyes.", image: "/assets/images/lovage.jpg")
